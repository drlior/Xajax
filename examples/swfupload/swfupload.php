...
<div id="example">
    ...
    <form enctype="multipart/form-data" id="upload_form" action="upload.php" onsubmit="return false;" method="post">
        ...
        <div style="font-size:11px;">
            The file size is limited to 5MB. Don't even think about hijacking the form, all your uploads will safely be
            stored in /dev/null. :)
        </div>
        ...
        <div class="formField"><input id="uploadBtn2" type="button"
                                      onclick="xajax_uploader(xajax.getFormValues('upload_form'));"
                                      value="upload file"/></div>
        <div style="clear:both;"></div>

        <div style="clear:both;"></div>
        <div class="formLabel">&nbsp;</div>
        <div class="formField"><input id="uploadBtn3" type="button" onclick="xajax_transform();"
                                      value="create swf upload"/></div>
        <div style="clear:both;"></div>


        <div style="clear:both;"></div>
        <div class="formLabel">&nbsp;</div>
        <div class="formField"><input id="uploadBtn4" type="button" onclick="xajax_destroyform('upload_form');"
                                      value="destroy form"/></div>
        <div style="clear:both;"></div>
    ...
    <div style="clear:both;"></div>
    <div class="formLabel">&nbsp;</div>
    <div class="formField"><input id="uploadBtn5" type="button" onclick="xajax_transfield();"
                                  value="create swf upload field"/></div>
    <div style="clear:both;"></div>


    <div style="clear:both;"></div>
    <div class="formLabel">&nbsp;</div>
    <div class="formField"><input id="uploadBtn6" type="button" onclick="xajax_destroyfield();" value="destroy field"/>
    </div>
    <div style="clear:both;"></div>
